...
from experiments.evolutionary_algorithms.evolutionary_algorithm_configs import (
    CellularEvolutionaryAlgorithmConfig,
)
...
from rl_testing.evolutionary_algorithms.populations import (
    CellularPopulation,
    Population,
)
...
class CellularEvolutionaryAlgorithm(AsyncEvolutionaryAlgorithm):
    def __init__(
        self,
        evolutionary_algorithm_config: CellularEvolutionaryAlgorithmConfig,
        ...
        self.num_rows = evolutionary_algorithm_config.num_rows
        self.num_columns = evolutionary_algorithm_config.num_columns
        self.crossover_mode = evolutionary_algorithm_config.crossover_mode
        self.apply_operators_on_original_grid = (
            evolutionary_algorithm_config.apply_operators_on_original_grid
        )
    ...
    async def initialize(self, seed: int) -> None:
        ...
        self.population = CellularPopulation(
            ...
            pool=self.pool,
            apply_operators_on_original_grid=self.apply_operators_on_original_grid,
...
async def main(experiment_config_dict: Dict[str, Any], logger: logging.Logger) -> None:
    ...
    evolutionary_algorithm_config = CellularEvolutionaryAlgorithmConfig.from_yaml_file(
...
if __name__ == "__main__":
    ...
    parser.add_argument("--evolutionary_algorithm_config_name", type=str,  default="config_cellular_population_small.yaml")  # noqa: E501
