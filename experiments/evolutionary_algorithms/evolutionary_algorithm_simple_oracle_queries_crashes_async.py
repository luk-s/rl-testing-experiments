...
from rl_testing.evolutionary_algorithms.fitnesses import (  # DifferentialTestingFitness,
...
class SimpleOracleQueryEvolutionaryAlgorithm(AsyncEvolutionaryAlgorithm):
    def __init__(
        ...
        self.fitness: Optional[CrashTestingFitness] = None
    ...
    async def initialize(self, seed: int) -> None:
        ...
        self.fitness = CrashTestingFitness(
